...
if(isset($_SESSION['userId'])){
  $records = $conn->connectToDataBase()->prepare('SELECT userId, userMail, userName, userLastName, userMonth, userDay, userYear,userFirstLogin FROM Users WHERE userId = :userId');
